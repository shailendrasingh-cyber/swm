  ...
  return (
    <div className="flex flex-col bg-gradient-to-r from-zinc-100/30 via-amber-300/50 to-violet-400/25 w-full min-h-screen">
      ...
      <div className="container mx-auto px-4 py-6 mt-16">
        ...
        {showAbout ? (
          <div className="bg-white shadow p-6 mb-8 rounded">
            <h2 className="text-2xl font-bold mb-4">About This System</h2>
            <p>
              The Shivalik Smart Garbage Monitoring System is an advanced solution designed to optimize waste management processes. By leveraging IoT and smart sensors, the system provides real-time data on the fill levels of garbage bins, enabling efficient scheduling of waste collection and reducing operational costs. The system not only ensures cleaner environments but also promotes sustainability by minimizing unnecessary collection trips.
            </p>
            <button
          ...
          <div className="overflow-x-auto bg-white shadow-lg rounded-lg p-6">
            <table className="min-w-full bg-white">
              <thead>
                <tr>
                  <th className="py-2 px-4 border-b">Bin</th>
              ...
              <tbody>
                {Object.entries(binsData).map(([bin, status]) => (
                  <tr key={bin}>
                    <td className="py-2 px-4 border-b">{bin}</td>
                    <td className={`py-2 px-4 border-b ${getStatusColor(status)}`}>{status}</td>
